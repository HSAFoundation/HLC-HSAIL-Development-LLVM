...
define void @positive_imm_offset_arg(i32 addrspace(1)* %out, i32 addrspace(1)* %in) {
  %gep = getelementptr i32 addrspace(1)* %in, i32 7
  %a = load i32 addrspace(1)* %gep
  %result = add i32 %a, %a
  store i32 %result, i32 addrspace(1)* %out
  ret void
}
...
define void @negative_imm_offset_arg(i32 addrspace(1)* %out, i32 addrspace(1)* %in) {
  %gep = getelementptr i32 addrspace(1)* %in, i32 -9
  %a = load i32 addrspace(1)* %gep
  %result = add i32 %a, %a
  store i32 %result, i32 addrspace(1)* %out
  ret void
...
define void @directly_load_global(i32 addrspace(1)* %out) {
  %a = load i32 addrspace(3)* getelementptr inbounds ([128 x i32] addrspace(3)* @lds_global, i32 0, i32 0)
  %result = add i32 %a, %a
  store i32 %result, i32 addrspace(1)* %out
  ret void
}
...
define void @positive_imm_offset_global(i32 addrspace(1)* %out) {
  %a = load i32 addrspace(3)* getelementptr inbounds ([128 x i32] addrspace(3)* @lds_global, i32 0, i32 7)
  %result = add i32 %a, %a
  store i32 %result, i32 addrspace(1)* %out
  ret void
}
...
define void @reg_offset_global(i32 addrspace(1)* %out) {
  ...
  %gep = getelementptr [128 x i32] addrspace(3)* @lds_global, i32 0, i32 %tid
  %a = load i32 addrspace(3)* %gep
  %result = add i32 %a, %a
  store i32 %result, i32 addrspace(1)* %out
  ret void
}
...
define void @reg_offset_positive_offset_global(i32 addrspace(1)* %out) {
  ...
  %gep = getelementptr [128 x i32] addrspace(3)* @lds_global, i32 0, i32 %tid_offset
  %a = load i32 addrspace(3)* %gep
  %result = add i32 %a, %a
  store i32 %result, i32 addrspace(1)* %out
  ret void
