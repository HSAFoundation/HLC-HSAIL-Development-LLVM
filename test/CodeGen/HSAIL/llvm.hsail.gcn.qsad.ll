...
declare i64 @llvm.hsail.gcn.qsad(i64, i64, i64) #0
...
define i64 @test_qsad_i64(i64 %x, i64 %y, i64 %z) #0 {
  %val = call i64 @llvm.hsail.gcn.qsad(i64 %x, i64 %y, i64 %z) #0
  ret i64 %val
}
...
define i64 @test_qsad_i64_rii(i64 %x) #0 {
  %val = call i64 @llvm.hsail.gcn.qsad(i64 %x, i64 16777216, i64 2) #0
  ret i64 %val
}
...
define i64 @test_qsad_i64_rir(i64 %x, i64 %y) #0 {
  %val = call i64 @llvm.hsail.gcn.qsad(i64 %x, i64 1, i64 %y) #0
  ret i64 %val
}
...
define i64 @test_qsad_i64_rri(i64 %x, i64 %y) #0 {
  %val = call i64 @llvm.hsail.gcn.qsad(i64 %x, i64 %y, i64 7) #0
  ret i64 %val
}
...
define i64 @test_qsad_i64_iri(i64 %x) #0 {
  %val = call i64 @llvm.hsail.gcn.qsad(i64 342421, i64 %x, i64 9) #0
  ret i64 %val
}
...
define i64 @test_qsad_i64_iir(i64 %x) #0 {
  %val = call i64 @llvm.hsail.gcn.qsad(i64 256, i64 65536, i64 %x) #0
  ret i64 %val
}
...
define i64 @test_qsad_i64_iii() #0 {
  %val = call i64 @llvm.hsail.gcn.qsad(i64 3, i64 1234, i64 11) #0
  ret i64 %val
}

; HSAIL-LABEL: {{^}}prog function &test_legacy_qsad_i64(
; HSAIL: gcn_qsad_b64 {{\$d[0-9]+}}, {{\$d[0-9]+}}, {{\$d[0-9]+}}, {{\$d[0-9]+}};
define i64 @test_legacy_qsad_i64(i64 %x, i64 %y, i64 %z) #0 {
