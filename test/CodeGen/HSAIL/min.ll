...
define void @v_test_imin_sle_i64(i64 addrspace(1)* %out, i64 addrspace(1)* %aptr, i64 addrspace(1)* %bptr) #1 {
  %tid = call i32 @llvm.HSAIL.get.global.id(i32 0) #0
  %gep0 = getelementptr i64 addrspace(1)* %aptr, i32 %tid
  %gep1 = getelementptr i64 addrspace(1)* %bptr, i32 %tid
  %outgep = getelementptr i64 addrspace(1)* %out, i32 %tid
  %a = load i64 addrspace(1)* %gep0
  %b = load i64 addrspace(1)* %gep1
...
define void @v_test_umin_ult_i64_multi_use(i64 addrspace(1)* %out0, i1 addrspace(1)* %out1, i64 addrspace(1)* %aptr, i64 addrspace(1)* %bptr) #1 {
  ...
  %gep0 = getelementptr i64 addrspace(1)* %aptr, i32 %tid
  %gep1 = getelementptr i64 addrspace(1)* %bptr, i32 %tid
  %outgep0 = getelementptr i64 addrspace(1)* %out0, i32 %tid
  %outgep1 = getelementptr i1 addrspace(1)* %out1, i32 %tid
  %a = load i64 addrspace(1)* %gep0
  %b = load i64 addrspace(1)* %gep1
  %cmp = icmp ult i64 %a, %b
