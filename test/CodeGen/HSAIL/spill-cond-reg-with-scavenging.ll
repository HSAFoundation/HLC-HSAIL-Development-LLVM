...
define void @test_spill_cond_reg_with_scavenging(i1 addrspace(1)* %out, i32 addrspace(1)* %in, i32 addrspace(1)* %s) #0 {
  ...
  %a = load volatile i32 addrspace(1)* %in
  %b = load volatile i32 addrspace(1)* %b_ptr
  %c = load volatile i32 addrspace(1)* %c_ptr
  %d = load volatile i32 addrspace(1)* %d_ptr
  %e = load volatile i32 addrspace(1)* %e_ptr

; Create lots of s register pressure.
  %s0_ptr = getelementptr i32 addrspace(1)* %s, i32 0
  %s1_ptr = getelementptr i32 addrspace(1)* %s, i32 1
  %s2_ptr = getelementptr i32 addrspace(1)* %s, i32 2
  %s3_ptr = getelementptr i32 addrspace(1)* %s, i32 3
  %s4_ptr = getelementptr i32 addrspace(1)* %s, i32 4
  %s5_ptr = getelementptr i32 addrspace(1)* %s, i32 5
  %s6_ptr = getelementptr i32 addrspace(1)* %s, i32 6
  %s7_ptr = getelementptr i32 addrspace(1)* %s, i32 7
  %s8_ptr = getelementptr i32 addrspace(1)* %s, i32 8
  %s9_ptr = getelementptr i32 addrspace(1)* %s, i32 9
  %s10_ptr = getelementptr i32 addrspace(1)* %s, i32 10
  %s11_ptr = getelementptr i32 addrspace(1)* %s, i32 11
  %s12_ptr = getelementptr i32 addrspace(1)* %s, i32 12
  %s13_ptr = getelementptr i32 addrspace(1)* %s, i32 13
  %s14_ptr = getelementptr i32 addrspace(1)* %s, i32 14
  %s15_ptr = getelementptr i32 addrspace(1)* %s, i32 15
  %s16_ptr = getelementptr i32 addrspace(1)* %s, i32 16
  %s17_ptr = getelementptr i32 addrspace(1)* %s, i32 17
  %s18_ptr = getelementptr i32 addrspace(1)* %s, i32 18
  %s19_ptr = getelementptr i32 addrspace(1)* %s, i32 19
  %s20_ptr = getelementptr i32 addrspace(1)* %s, i32 20
  %s21_ptr = getelementptr i32 addrspace(1)* %s, i32 21
  %s22_ptr = getelementptr i32 addrspace(1)* %s, i32 22
  %s23_ptr = getelementptr i32 addrspace(1)* %s, i32 23
  %s24_ptr = getelementptr i32 addrspace(1)* %s, i32 24
  %s25_ptr = getelementptr i32 addrspace(1)* %s, i32 25
  %s26_ptr = getelementptr i32 addrspace(1)* %s, i32 26
  %s27_ptr = getelementptr i32 addrspace(1)* %s, i32 27
  %s28_ptr = getelementptr i32 addrspace(1)* %s, i32 28
  %s29_ptr = getelementptr i32 addrspace(1)* %s, i32 29
  %s30_ptr = getelementptr i32 addrspace(1)* %s, i32 30
  %s31_ptr = getelementptr i32 addrspace(1)* %s, i32 31

  %s0 = load volatile i32 addrspace(1)* %s0_ptr
  %s1 = load volatile i32 addrspace(1)* %s1_ptr
  %s2 = load volatile i32 addrspace(1)* %s2_ptr
  %s3 = load volatile i32 addrspace(1)* %s3_ptr
  %s4 = load volatile i32 addrspace(1)* %s4_ptr
  %s5 = load volatile i32 addrspace(1)* %s5_ptr
  %s6 = load volatile i32 addrspace(1)* %s6_ptr
  %s7 = load volatile i32 addrspace(1)* %s7_ptr
  %s8 = load volatile i32 addrspace(1)* %s8_ptr
  %s9 = load volatile i32 addrspace(1)* %s9_ptr
  %s10 = load volatile i32 addrspace(1)* %s10_ptr
  %s11 = load volatile i32 addrspace(1)* %s11_ptr
  %s12 = load volatile i32 addrspace(1)* %s12_ptr
  %s13 = load volatile i32 addrspace(1)* %s13_ptr
  %s14 = load volatile i32 addrspace(1)* %s14_ptr
  %s15 = load volatile i32 addrspace(1)* %s15_ptr
  %s16 = load volatile i32 addrspace(1)* %s16_ptr
  %s17 = load volatile i32 addrspace(1)* %s17_ptr
  %s18 = load volatile i32 addrspace(1)* %s18_ptr
  %s19 = load volatile i32 addrspace(1)* %s19_ptr
  %s20 = load volatile i32 addrspace(1)* %s20_ptr
  %s21 = load volatile i32 addrspace(1)* %s21_ptr
  %s22 = load volatile i32 addrspace(1)* %s22_ptr
  %s23 = load volatile i32 addrspace(1)* %s23_ptr
  %s24 = load volatile i32 addrspace(1)* %s24_ptr
  %s25 = load volatile i32 addrspace(1)* %s25_ptr
  %s26 = load volatile i32 addrspace(1)* %s26_ptr
  %s27 = load volatile i32 addrspace(1)* %s27_ptr
  %s28 = load volatile i32 addrspace(1)* %s28_ptr
  %s29 = load volatile i32 addrspace(1)* %s29_ptr
  %s30 = load volatile i32 addrspace(1)* %s30_ptr
  %s31 = load volatile i32 addrspace(1)* %s31_ptr

  %s32 = load volatile i32 addrspace(1)* %s
  %s33 = load volatile i32 addrspace(1)* %s
  %s34 = load volatile i32 addrspace(1)* %s
  %s35 = load volatile i32 addrspace(1)* %s
  %s36 = load volatile i32 addrspace(1)* %s
  %s37 = load volatile i32 addrspace(1)* %s
  %s38 = load volatile i32 addrspace(1)* %s
  %s39 = load volatile i32 addrspace(1)* %s
  %s40 = load volatile i32 addrspace(1)* %s
  %s41 = load volatile i32 addrspace(1)* %s
  %s42 = load volatile i32 addrspace(1)* %s
  %s43 = load volatile i32 addrspace(1)* %s
  %s44 = load volatile i32 addrspace(1)* %s
  %s45 = load volatile i32 addrspace(1)* %s
  %s46 = load volatile i32 addrspace(1)* %s
  %s47 = load volatile i32 addrspace(1)* %s
  %s48 = load volatile i32 addrspace(1)* %s
  %s49 = load volatile i32 addrspace(1)* %s
  %s50 = load volatile i32 addrspace(1)* %s
  %s51 = load volatile i32 addrspace(1)* %s
  %s52 = load volatile i32 addrspace(1)* %s
  %s53 = load volatile i32 addrspace(1)* %s
  %s54 = load volatile i32 addrspace(1)* %s
  %s55 = load volatile i32 addrspace(1)* %s
  %s56 = load volatile i32 addrspace(1)* %s
  %s57 = load volatile i32 addrspace(1)* %s
  %s58 = load volatile i32 addrspace(1)* %s
  %s59 = load volatile i32 addrspace(1)* %s
  %s60 = load volatile i32 addrspace(1)* %s
  %s61 = load volatile i32 addrspace(1)* %s
  %s62 = load volatile i32 addrspace(1)* %s
  %s63 = load volatile i32 addrspace(1)* %s

  %s64 = load volatile i32 addrspace(1)* %s
  %s65 = load volatile i32 addrspace(1)* %s
  %s66 = load volatile i32 addrspace(1)* %s
  %s67 = load volatile i32 addrspace(1)* %s
  %s68 = load volatile i32 addrspace(1)* %s
  %s69 = load volatile i32 addrspace(1)* %s
  %s70 = load volatile i32 addrspace(1)* %s
  %s71 = load volatile i32 addrspace(1)* %s
  %s72 = load volatile i32 addrspace(1)* %s
  %s73 = load volatile i32 addrspace(1)* %s
  %s74 = load volatile i32 addrspace(1)* %s
  %s75 = load volatile i32 addrspace(1)* %s
  %s76 = load volatile i32 addrspace(1)* %s
  %s77 = load volatile i32 addrspace(1)* %s
  %s78 = load volatile i32 addrspace(1)* %s
  %s79 = load volatile i32 addrspace(1)* %s
  %s80 = load volatile i32 addrspace(1)* %s
  %s81 = load volatile i32 addrspace(1)* %s
  %s82 = load volatile i32 addrspace(1)* %s
  %s83 = load volatile i32 addrspace(1)* %s
  %s84 = load volatile i32 addrspace(1)* %s
  %s85 = load volatile i32 addrspace(1)* %s
  %s86 = load volatile i32 addrspace(1)* %s
  %s87 = load volatile i32 addrspace(1)* %s
  %s88 = load volatile i32 addrspace(1)* %s
  %s89 = load volatile i32 addrspace(1)* %s
  %s90 = load volatile i32 addrspace(1)* %s
  %s91 = load volatile i32 addrspace(1)* %s
  %s92 = load volatile i32 addrspace(1)* %s
  %s93 = load volatile i32 addrspace(1)* %s
  %s94 = load volatile i32 addrspace(1)* %s
  %s95 = load volatile i32 addrspace(1)* %s

  %s96 = load volatile i32 addrspace(1)* %s
  %s97 = load volatile i32 addrspace(1)* %s
  %s98 = load volatile i32 addrspace(1)* %s
  %s99 = load volatile i32 addrspace(1)* %s
  %s100 = load volatile i32 addrspace(1)* %s
  %s101 = load volatile i32 addrspace(1)* %s
  %s102 = load volatile i32 addrspace(1)* %s
  %s103 = load volatile i32 addrspace(1)* %s
  %s104 = load volatile i32 addrspace(1)* %s
  %s105 = load volatile i32 addrspace(1)* %s
  %s106 = load volatile i32 addrspace(1)* %s
  %s107 = load volatile i32 addrspace(1)* %s
  %s108 = load volatile i32 addrspace(1)* %s
  %s109 = load volatile i32 addrspace(1)* %s
  %s110 = load volatile i32 addrspace(1)* %s
  %s111 = load volatile i32 addrspace(1)* %s
  %s112 = load volatile i32 addrspace(1)* %s
  %s113 = load volatile i32 addrspace(1)* %s
  %s114 = load volatile i32 addrspace(1)* %s
  %s115 = load volatile i32 addrspace(1)* %s
  %s116 = load volatile i32 addrspace(1)* %s
  %s117 = load volatile i32 addrspace(1)* %s
  %s118 = load volatile i32 addrspace(1)* %s
  %s119 = load volatile i32 addrspace(1)* %s
  %s120 = load volatile i32 addrspace(1)* %s
  %s121 = load volatile i32 addrspace(1)* %s
  %s122 = load volatile i32 addrspace(1)* %s
  %s123 = load volatile i32 addrspace(1)* %s
  %s124 = load volatile i32 addrspace(1)* %s
  %s125 = load volatile i32 addrspace(1)* %s
  %s126 = load volatile i32 addrspace(1)* %s
  %s127 = load volatile i32 addrspace(1)* %s

  %s128 = load volatile i32 addrspace(1)* %s
  %s129 = load volatile i32 addrspace(1)* %s
  %s130 = load volatile i32 addrspace(1)* %s
  %s131 = load volatile i32 addrspace(1)* %s
  %s132 = load volatile i32 addrspace(1)* %s
