...
define void @test_spill_cond_reg(i1 addrspace(1)* %out, i32 addrspace(1)* %in) {
  ...
  %f_ptr = getelementptr i32, i32 addrspace(1)* %in, i32 5
  %a = load i32, i32 addrspace(1)* %in
  %b = load i32, i32 addrspace(1)* %b_ptr
  %c = load i32, i32 addrspace(1)* %c_ptr
  %d = load i32, i32 addrspace(1)* %d_ptr
  %e = load i32, i32 addrspace(1)* %e_ptr
...
define i32 @test_spill_cond_reg_priv(i1 addrspace(1)* %out, i32 addrspace(1)* %in, i32 %index0, i32 %index1) {
  ...
  %gep.0 = getelementptr [13 x i32], [13 x i32]* %alloca, i32 0, i32 %index0
  %gep.1 = getelementptr [13 x i32], [13 x i32]* %alloca, i32 0, i32 %index1
...
bb:
  ...
  %and5 = and i1 %and4, %cmp7
  %and6 = and i1 %and5, %cmp8
  %gep.2 = getelementptr i32, i32* %gep.1, i32 3
  %load = load i32, i32* %gep.2
  store i1 %and6, i1 addrspace(1)* %out
  ret i32 %load
