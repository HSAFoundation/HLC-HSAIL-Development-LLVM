; RUN: llc < %s -march=hsail -filetype=asm | FileCheck -check-prefix=HSAIL -check-prefix=FUNC %s

; FUNC-LABEL: {{^}}prog function &rotl_i32
...
; FUNC-LABEL: {{^}}prog function &rotl_v2i32
; HSAIL: neg_s32 {{\$s[0-9]+}}, {{\$s[0-9]+}};
; HSAIL: bitalign_b32 {{\$s[0-9]+}}, {{\$s[0-9]+}}, {{\$s[0-9]+}}, {{\$s[0-9]+}};
; HSAIL: neg_s32 {{\$s[0-9]+}}, {{\$s[0-9]+}};
; HSAIL: bitalign_b32 {{\$s[0-9]+}}, {{\$s[0-9]+}}, {{\$s[0-9]+}}, {{\$s[0-9]+}};
...
; FUNC-LABEL: {{^}}prog function &rotl_v4i32
; HSAIL: neg_s32 {{\$s[0-9]+}}, {{\$s[0-9]+}};
; HSAIL: bitalign_b32 {{\$s[0-9]+}}, {{\$s[0-9]+}}, {{\$s[0-9]+}}, {{\$s[0-9]+}};
; HSAIL: neg_s32 {{\$s[0-9]+}}, {{\$s[0-9]+}};
; HSAIL: bitalign_b32 {{\$s[0-9]+}}, {{\$s[0-9]+}}, {{\$s[0-9]+}}, {{\$s[0-9]+}};
