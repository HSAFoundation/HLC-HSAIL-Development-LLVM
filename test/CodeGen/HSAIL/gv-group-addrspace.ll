...
define void @test_scalar_i32(i32 addrspace(1)* %out) {
  %tmp1 = load i32 addrspace(3)* @scalar_i32
...
define void @test_scalar_f32(float addrspace(1)* %out) {
  %tmp1 = load float addrspace(3)* @scalar_f32
...
define void @test_vector_v4i32(<4 x i32> addrspace(1)* %out) {
  %tmp1 = load <4 x i32> addrspace(3)* @vector_v4i32
...
define void @test_vector_v3i32(<3 x i32> addrspace(1)* %out) {
  %tmp1 = load <3 x i32> addrspace(3)* @vector_v3i32
...
define void @test_scalar_i1(i1 addrspace(1)* %out) {
  %tmp1 = load i1 addrspace(3)* @scalar_i1
...
define void @test_array_i32(i32 addrspace(1)* %out, i32 %index) {
  %tmp0 = getelementptr inbounds [7 x i32] addrspace(3)* @array_i32, i32 0, i32 %index
...
define void @test_float_array_gv(float addrspace(1)* %out, i32 %index) {
  %tmp0 = getelementptr inbounds [5 x float] addrspace(3)* @float_array_gv, i32 0, i32 %index
  %tmp1 = load float addrspace(3)* %tmp0
  store float %tmp1, float addrspace(1)* %out
  ret void
}
...
define void @test_double_array_gv(double addrspace(1)* %out, i32 %index) {
  %tmp0 = getelementptr inbounds [5 x double] addrspace(3)* @double_array_gv, i32 0, i32 %index
  %tmp1 = load double addrspace(3)* %tmp0
...
define void @struct_foo_gv_load(i32 addrspace(1)* %out, i32 %index) {
  %gep = getelementptr inbounds %struct.foo addrspace(3)* @struct_foo_gv, i32 0, i32 1, i32 1
  %load = load i32 addrspace(3)* %gep, align 4
...
define void @array_struct_foo_gv_load(i32 addrspace(1)* %out, i32 %index) {
  %gep = getelementptr inbounds [10 x %struct.foo] addrspace(3)* @array_struct_foo_gv, i32 0, i32 0, i32 1, i32 %index
  %load = load i32 addrspace(3)* %gep, align 4
  store i32 %load, i32 addrspace(1)* %out, align 4
  ret void
}
...
define void @array_v1_gv_load(<1 x i32> addrspace(1)* %out, i32 %index) {
  %gep = getelementptr inbounds [4 x <1 x i32>] addrspace(3)* @array_v1_gv, i32 0, i32 %index
  %load = load <1 x i32> addrspace(3)* %gep, align 4
