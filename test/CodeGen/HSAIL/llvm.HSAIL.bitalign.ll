...
define i32 @test_bitalign_i32_rii(i32 %x) #0 {
  %val = call i32 @llvm.HSAIL.bitalign.b32(i32 %x, i32 1, i32 2) #0
  ret i32 %val
}
...
define i32 @test_bitalign_i32_rir(i32 %x, i32 %y) #0 {
  %val = call i32 @llvm.HSAIL.bitalign.b32(i32 %x, i32 1, i32 %y) #0
  ret i32 %val
}
...
define i32 @test_bitalign_i32_rri(i32 %x, i32 %y) #0 {
  %val = call i32 @llvm.HSAIL.bitalign.b32(i32 %x, i32 %y, i32 7) #0
  ret i32 %val
}
...
define i32 @test_bitalign_i32_iri(i32 %x) #0 {
  %val = call i32 @llvm.HSAIL.bitalign.b32(i32 3, i32 %x, i32 7) #0
  ret i32 %val
}
...
define i32 @test_bitalign_i32_iir(i32 %x) #0 {
  %val = call i32 @llvm.HSAIL.bitalign.b32(i32 3, i32 9, i32 %x) #0
  ret i32 %val
}
...
define i32 @test_bitalign_i32_iii() #0 {
  %val = call i32 @llvm.HSAIL.bitalign.b32(i32 3, i32 9, i32 11) #0
  ret i32 %val
}
