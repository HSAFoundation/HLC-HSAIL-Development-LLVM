...
; HSAIL-LABEL: {{^}}prog function &empty_func_with_return_type(arg_f32 %__ret_empty_func_with_return_type)()
; HSAIL-NEXT: {
; HSAIL-NOT: ret;
; HSAIL: };
...
; HSAIL-LABEL: {{^}}prog function &empty_func_with_struct_return_type(align(4) arg_u8 %__ret_empty_func_with_struct_return_type[8])()
; HSAIL-NEXT: {
; HSAIL-NOT: ret;
; HSAIL: };
...
; HSAIL-LABEL: {{^}}prog function &empty_func_with_sext_return_type(arg_s32 %__ret_empty_func_with_sext_return_type)()
; HSAIL-NEXT: {
; HSAIL-NOT: ret;
; HSAIL: };
...
; HSAIL-LABEL: {{^}}prog function &empty_func_with_zext_return_type(arg_u32 %__ret_empty_func_with_zext_return_type)()
; HSAIL-NEXT: {
; HSAIL-NOT: ret;
; HSAIL: };
...
; HSAIL-LABEL: {{^}}prog function &unreachable_func_with_return_type(arg_f32 %__ret_unreachable_func_with_return_type)(arg_u32 %out)
; HSAIL-NEXT: {
