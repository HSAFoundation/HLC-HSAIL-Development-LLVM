...
; HSAIL: st_private_align(4)_u64 4294967296, [%__privateStack][4];
...
entry:
  %alloca = alloca [16 x i32]
  %gep0 = getelementptr [16 x i32], [16 x i32]* %alloca, i32 0, i32 0
  %gep1 = getelementptr [16 x i32], [16 x i32]* %alloca, i32 0, i32 3
  %gep2 = getelementptr [16 x i32], [16 x i32]* %alloca, i32 0, i32 8
  %gep3 = getelementptr [16 x i32], [16 x i32]* %alloca, i32 0, i32 %index
  %gep3.sum1 = add i32 %index, 2
  %gep4 = getelementptr [16 x i32], [16 x i32]* %alloca, i32 0, i32 %gep3.sum1
  ...
  %gep5 = getelementptr [16 x i32], [16 x i32]* %alloca, i32 0, i32 %gep3.sum
  %load = load i32, i32* %gep5
  store i32 %load, i32 addrspace(1)* %out
  ret void
}
