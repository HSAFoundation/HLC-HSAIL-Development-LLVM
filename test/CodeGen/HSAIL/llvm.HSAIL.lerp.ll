...
; HSAIL: lerp_u8x4 {{\$s[0-9]+}}, {{\$s[0-9]+}}, _u8x4(1,0,0,0), _u8x4(0,0,0,2);
...
; HSAIL: lerp_u8x4 {{\$s[0-9]+}}, {{\$s[0-9]+}}, _u8x4(0,0,0,1), {{\$s[0-9]+}};
...
; HSAIL: lerp_u8x4 {{\$s[0-9]+}}, {{\$s[0-9]+}}, {{\$s[0-9]+}}, _u8x4(0,0,0,7);
...
; HSAIL: lerp_u8x4 {{\$s[0-9]+}}, _u8x4(0,5,57,149), {{\$s[0-9]+}},  _u8x4(65,242,128,0);
...
; HSAIL: lerp_u8x4 {{\$s[0-9]+}}, _u8x4(0,0,1,0), _u8x4(0,1,0,0), {{\$s[0-9]+}};
...
; HSAIL: lerp_u8x4 {{\$s[0-9]+}},  _u8x4(0,0,0,3), _u8x4(0,0,4,210), _u8x4(0,0,0,11);
