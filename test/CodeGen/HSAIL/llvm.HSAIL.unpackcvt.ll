...
define float @test_unpackcvt_f32_u8x4_1(i32 %x) #0 {
  %val = call float @llvm.HSAIL.unpackcvt.f32.u8x4(i32 %x, i32 1) #0
  ret float %val
}
...
define float @test_unpackcvt_f32_u8x4_2(i32 %x) #0 {
  %val = call float @llvm.HSAIL.unpackcvt.f32.u8x4(i32 %x, i32 2) #0
  ret float %val
}
...
define float @test_unpackcvt_f32_u8x4_3(i32 %x) #0 {
  %val = call float @llvm.HSAIL.unpackcvt.f32.u8x4(i32 %x, i32 3) #0
  ret float %val
}
