...
define i64 @test_mqsad_i64_rii(i64 %x) #0 {
  %val = call i64 @llvm.HSAIL.mqsad(i64 %x, i32 16777216, i64 2) #0
  ret i64 %val
}
...
define i64 @test_mqsad_i64_rir(i64 %x, i64 %y) #0 {
  %val = call i64 @llvm.HSAIL.mqsad(i64 %x, i32 1, i64 %y) #0
  ret i64 %val
}
...
define i64 @test_mqsad_i64_rri(i64 %x, i32 %y) #0 {
  %val = call i64 @llvm.HSAIL.mqsad(i64 %x, i32 %y, i64 7) #0
  ret i64 %val
}
...
define i64 @test_mqsad_i64_iri(i32 %x) #0 {
  %val = call i64 @llvm.HSAIL.mqsad(i64 342421, i32 %x, i64 9) #0
  ret i64 %val
}
...
define i64 @test_mqsad_i64_iir(i64 %x) #0 {
  %val = call i64 @llvm.HSAIL.mqsad(i64 256, i32 65536, i64 %x) #0
  ret i64 %val
}
...
define i64 @test_mqsad_i64_iii() #0 {
  %val = call i64 @llvm.HSAIL.mqsad(i64 3, i32 1234, i64 11) #0
  ret i64 %val
}
