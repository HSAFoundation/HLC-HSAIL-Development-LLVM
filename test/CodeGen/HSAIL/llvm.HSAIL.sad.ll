...
; HSAIL: sad_u32_u8x4 {{\$s[0-9]+}}, {{\$s[0-9]+}}, _u8x4(1,0,0,0), 2;
...
; HSAIL: sad_u32_u8x4 {{\$s[0-9]+}}, {{\$s[0-9]+}}, _u8x4(0,0,0,1), {{\$s[0-9]+}};
...
; HSAIL: sad_u32_u8x4 {{\$s[0-9]+}}, _u8x4(0,5,57,149), {{\$s[0-9]+}}, 9;
...
; HSAIL: sad_u32_u8x4 {{\$s[0-9]+}}, _u8x4(0,0,1,0), _u8x4(0,1,0,0), {{\$s[0-9]+}};
...
; HSAIL: sad_u32_u8x4 {{\$s[0-9]+}},  _u8x4(0,0,0,3), _u8x4(0,0,4,210), 11;
