...
define i32 @internal_gv_user() #0 {
  %tmp = getelementptr inbounds [1 x i32] addrspace(2)* @internal_gv, i64 0, i64 undef
  %val = load i32 addrspace(2)* %tmp
  ret i32 %val
}

define i32 @available_externally_gv_user() #0 {
  %tmp = getelementptr inbounds [1 x i32] addrspace(2)* @available_externally_gv, i64 0, i64 undef
  %val = load i32 addrspace(2)* %tmp
  ret i32 %val
}

define i32 @linkonce_gv_user() #0 {
  %tmp = getelementptr inbounds [1 x i32] addrspace(2)* @linkonce_gv, i64 0, i64 undef
  %val = load i32 addrspace(2)* %tmp
  ret i32 %val
}

define i32 @weak_gv_user() #0 {
  %tmp = getelementptr inbounds [1 x i32] addrspace(2)* @weak_gv, i64 0, i64 undef
  %val = load i32 addrspace(2)* %tmp
  ret i32 %val
}

define i32 @common_gv_user() #0 {
  %tmp = getelementptr inbounds [1 x i32] addrspace(2)* @common_gv, i64 0, i64 undef
  %val = load i32 addrspace(2)* %tmp
  ret i32 %val
}

define i32 @appending_gv_user() #0 {
  %tmp = getelementptr inbounds [1 x i32] addrspace(2)* @appending_gv, i64 0, i64 undef
  %val = load i32 addrspace(2)* %tmp
  ret i32 %val
}

define i32 @extern_weak_gv_user() #0 {
  %tmp = getelementptr inbounds [1 x i32] addrspace(2)* @extern_weak_gv, i64 0, i64 undef
  %val = load i32 addrspace(2)* %tmp
  ret i32 %val
}

define i32 @linkonce_odr_gv_user() #0 {
  %tmp = getelementptr inbounds [1 x i32] addrspace(2)* @linkonce_odr_gv, i64 0, i64 undef
  %val = load i32 addrspace(2)* %tmp
  ret i32 %val
}

define i32 @weak_odr_gv_user() #0 {
  %tmp = getelementptr inbounds [1 x i32] addrspace(2)* @weak_odr_gv, i64 0, i64 undef
  %val = load i32 addrspace(2)* %tmp
  ret i32 %val
}

define i32 @external_gv_user() #0 {
  %tmp = getelementptr inbounds [1 x i32] addrspace(2)* @external_gv, i64 0, i64 undef
  %val = load i32 addrspace(2)* %tmp
  ret i32 %val
}
