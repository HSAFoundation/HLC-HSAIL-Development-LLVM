...
define i32 @test_packcvt_u8x4_f32_rrri(float %x, float %y, float %z) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float %x, float %y, float %z, float 1.0) #0
  ret i32 %val
}
...
define i32 @test_packcvt_u8x4_f32_rrir(float %x, float %y, float %z) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float %x, float %y, float 1.0, float %z) #0
  ret i32 %val
}
...
define i32 @test_packcvt_u8x4_f32_rirr(float %x, float %y, float %z) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float %x, float 1.0, float %y, float %z) #0
  ret i32 %val
}
...
define i32 @test_packcvt_u8x4_f32_irrr(float %x, float %y, float %z) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float 1.0, float %x, float %y, float %z) #0
  ret i32 %val
}
...
define i32 @test_packcvt_u8x4_f32_iirr(float %x, float %y) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float 1.0, float 2.0, float %x, float %y) #0
  ret i32 %val
}
...
define i32 @test_packcvt_u8x4_f32_riir(float %x, float %y) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float %x, float 1.0, float 2.0, float %y) #0
  ret i32 %val
}
...
define i32 @test_packcvt_u8x4_f32_rrii(float %x, float %y) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float %x, float %y, float 1.0, float 2.0) #0
  ret i32 %val
}
...
define i32 @test_packcvt_u8x4_f32_riri(float %x, float %y) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float %x, float 1.0, float %y, float 2.0) #0
  ret i32 %val
}
...
define i32 @test_packcvt_u8x4_f32_irir(float %x, float %y) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float 1.0, float %x, float 2.0, float %y) #0
  ret i32 %val
}
...
define i32 @test_packcvt_u8x4_f32_iiir(float %x) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float 1.0, float 2.0, float 3.0, float %x) #0
  ret i32 %val
}
...
define i32 @test_packcvt_u8x4_f32_riii(float %x) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float %x, float 1.0, float 2.0, float 3.0) #0
  ret i32 %val
}
...
define i32 @test_packcvt_u8x4_f32_iiii(float %x) #0 {
  %val = call i32 @llvm.HSAIL.packcvt.u8x4.f32(float 1.0, float 2.0, float 3.0, float 4.0) #0
  ret i32 %val
}
