...
declare i32 @llvm.hsail.bytealign(i32, i32, i32) #0
...
define i32 @test_bytealign_i32(i32 %x, i32 %y, i32 %z) #0 {
  %val = call i32 @llvm.hsail.bytealign(i32 %x, i32 %y, i32 %z) #0
  ret i32 %val
}

; HSAIL-LABEL: {{^}}prog function &test_legacy_bytealign_i32(
; HSAIL: bytealign_b32 {{\$s[0-9]+}}, {{\$s[0-9]+}}, {{\$s[0-9]+}}, {{\$s[0-9]+}};
define i32 @test_legacy_bytealign_i32(i32 %x, i32 %y, i32 %z) #0 {
