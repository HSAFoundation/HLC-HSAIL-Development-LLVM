...
define void @local_memory_i32(i32 addrspace(1)* %out) #0 {
  ...
  %arrayidx = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @local_memory_i32.local_mem, i32 0, i32 %y.i
  ...
  %arrayidx1 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @local_memory_i32.local_mem, i32 0, i32 %.add
  %tmp0 = load i32, i32 addrspace(3)* %arrayidx1, align 4
...
define void @local_memory_i8(i8 addrspace(1)* %out) #0 {
  %y.i = call i32 @llvm.HSAIL.workitemid.flat() #0
  %arrayidx = getelementptr inbounds [128 x i8], [128 x i8] addrspace(3)* @local_memory_i8.local_mem, i32 0, i32 %y.i
  ...
  %.add = select i1 %cmp, i32 0, i32 %add
  call void @llvm.HSAIL.barrier()
  %arrayidx1 = getelementptr inbounds [128 x i8], [128 x i8] addrspace(3)* @local_memory_i8.local_mem, i32 0, i32 %.add
  %tmp0 = load i8, i8 addrspace(3)* %arrayidx1
  %arrayidx2 = getelementptr inbounds i8, i8 addrspace(1)* %out, i32 %y.i
...
define void @local_memory_i16(i16 addrspace(1)* %out) #0 {
  %y.i = call i32 @llvm.HSAIL.workitemid.flat() #0
  %arrayidx = getelementptr inbounds [128 x i16], [128 x i16] addrspace(3)* @local_memory_i16.local_mem, i32 0, i32 %y.i
  ...
  %.add = select i1 %cmp, i32 0, i32 %add
  call void @llvm.HSAIL.barrier()
  %arrayidx1 = getelementptr inbounds [128 x i16], [128 x i16] addrspace(3)* @local_memory_i16.local_mem, i32 0, i32 %.add
  %tmp0 = load i16, i16 addrspace(3)* %arrayidx1
  %arrayidx2 = getelementptr inbounds i16, i16 addrspace(1)* %out, i32 %y.i
...
define void @local_memory_i64(i64 addrspace(1)* %out) #0 {
  %y.i = call i32 @llvm.HSAIL.workitemid.flat() #0
  %arrayidx = getelementptr inbounds [128 x i64], [128 x i64] addrspace(3)* @local_memory_i64.local_mem, i32 0, i32 %y.i
  ...
  %.add = select i1 %cmp, i32 0, i32 %add
  call void @llvm.HSAIL.barrier()
  %arrayidx1 = getelementptr inbounds [128 x i64], [128 x i64] addrspace(3)* @local_memory_i64.local_mem, i32 0, i32 %.add
  %tmp0 = load i64, i64 addrspace(3)* %arrayidx1
  %arrayidx2 = getelementptr inbounds i64, i64 addrspace(1)* %out, i32 %y.i
...
define void @local_memory_f32(float addrspace(1)* %out) #0 {
  %y.i = call i32 @llvm.HSAIL.workitemid.flat() #0
  %arrayidx = getelementptr inbounds [128 x float], [128 x float] addrspace(3)* @local_memory_f32.local_mem, i32 0, i32 %y.i
  ...
  %.add = select i1 %cmp, i32 0, i32 %add
  call void @llvm.HSAIL.barrier()
  %arrayidx1 = getelementptr inbounds [128 x float], [128 x float] addrspace(3)* @local_memory_f32.local_mem, i32 0, i32 %.add
  %tmp0 = load float, float addrspace(3)* %arrayidx1
  %arrayidx2 = getelementptr inbounds float, float addrspace(1)* %out, i32 %y.i
