...
entry:
  ...
  %tmp = load i32 addrspace(1)*, i32 addrspace(1)** %rowDelimiters.addr, align 8
  %tmp1 = load i32, i32* %aaa, align 4
  %tmp2 = add nsw i32 %tmp1, 5
  %conv3 = sext i32 %tmp2 to i64
  %arrayidx = getelementptr i32, i32 addrspace(1)* %tmp, i64 %conv3
  %tmp4 = load i32, i32 addrspace(1)* %arrayidx, align 4
  store i32 %tmp4, i32* %t, align 4
  %tmp5 = load float addrspace(1)*, float addrspace(1)** %out.addr, align 8
  %tmp6 = load i32, i32* %aaa, align 4
  %conv7 = sext i32 %tmp6 to i64
  %arrayidx8 = getelementptr float, float addrspace(1)* %tmp5, i64 %conv7
  %tmp9 = load i32, i32* %t, align 4
...
entry:
  ...
  %tmp4 = load i32, i32 addrspace(1)* %arrayidx, align 4
  store i32 %tmp4, i32* %t, align 4
  %tmp5 = load i32 addrspace(1)*, i32 addrspace(1)** %rowDelimiters.addr, align 8
  %tmp6 = load i32, i32* %aaa, align 4
  %tmp7 = add nsw i32 %tmp6, 10
  %conv8 = sext i32 %tmp7 to i64
  %arrayidx9 = getelementptr i32, i32 addrspace(1)* %tmp5, i64 %conv8
  %tmp10 = load i32, i32 addrspace(1)* %arrayidx9, align 4
  store i32 %tmp10, i32* %t2, align 4
  %tmp11 = load float addrspace(1)*, float addrspace(1)** %out.addr, align 8
  %tmp12 = load i32, i32* %aaa, align 4
  %conv13 = sext i32 %tmp12 to i64
  %arrayidx14 = getelementptr float, float addrspace(1)* %tmp11, i64 %conv13
  %tmp15 = load i32, i32* %t, align 4
  %tmp16 = load i32, i32* %t2, align 4
